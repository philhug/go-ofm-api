...
// ChangesDbParams contains all the bound params for the changes db operation
// typically these are obtained from a http.Request
//
// swagger:parameters changesDb
...
//
// To ensure default values, the struct must have been initialized with NewChangesDbParams() beforehand.
func (o *ChangesDbParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ChangesDbParams) bindDb(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ChangesDbParams) validateDb(formats strfmt.Registry) error {
